...
STARTER_TERMS = [
    ...
    {"english": "Compensation", "kinyarwanda": "Impozamarira / Inshumbusho / Igihembo", "example_en": "Participants will not receive compensation for taking part in this study.", "example_rw": "Nta gihembo giteganijwe mu kugira uruhare muri ubu bushakashatsi.", "etymology": "Three types: 'impozamarira' (legal/financial), 'inshumbusho' (restitution), 'igihembo' (reward/payment). Context determines the choice.", "category": "Research Ethics", "contributed_by": "Christophe Mumaragishyika", "source": "Annie Chibwe consent form"},
    ...
    {"english": 'Shortness of breath', "kinyarwanda": 'Guhera umwuka / Kubura umwuka', "example_en": None, "example_rw": None, "etymology": "'Umwuka' = air. 'Guhera umwuka' = air running out; 'kubura umwuka' = to lack air. Both render the deficiency descriptively, paralleling 'kubura amaraso' (anemia, 'to lack blood').", "category": 'Symptoms', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
    {"english": 'Miscarriage/abortion', "kinyarwanda": 'Gukuramo inda', "example_en": None, "example_rw": None, "etymology": None, "category": 'Reproductive Health', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
    {"english": 'Infertility', "kinyarwanda": 'Kutabyara', "example_en": None, "example_rw": None, "etymology": None, "category": 'Reproductive Health', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
    ...
    {"english": 'Epilepsy', "kinyarwanda": 'Igicuri', "example_en": None, "example_rw": None, "etymology": None, "category": 'Neurology', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
