...
STARTER_TERMS = [
 ...
 "variants_rw": "Isemeka", "example_en": "Asthma patients require regular follow-up at NCD clinics.", "example_rw": "Abarwayi barwaye gusemeka bakeneye gukurikiranwa buri gihe mu mavuriro y'indwara zitandura.", "etymology": "'Gusemeka' is the verbal form meaning 'to have difficulty breathing,' while 'isemeka' is the nominal form.", "category": "Pulmonology", "contributed_by": "Christophe Mumaragishyika", "source": "Annie Chibwe consent form"},
    ...
    {"english": "Compensation", "kinyarwanda": "Impozamarira",
 "variants_rw": "Inshumbusho / Igihembo", "example_en": "Participants will not receive compensation for taking part in this study.", "example_rw": "Nta gihembo giteganijwe mu kugira uruhare muri ubu bushakashatsi.", "etymology": "Three types: 'impozamarira' (legal/financial), 'inshumbusho' (restitution), 'igihembo' (reward/payment). Context determines the choice.", "category": "Research Ethics", "contributed_by": "Christophe Mumaragishyika", "source": "Annie Chibwe consent form"},
 ...
 "variants_en": "To combat a disease", "example_en": "What are the challenges you face in implementing strategies to fight diabetes type II?", "example_rw": "Imbogamizi uhura nazo mu gushyira mu bikorwa ingamba zo guhashya indwara ya gisukari yo mu bwoko bwa kabiri nizihe?", "etymology": "'Guhashya' = to fight against / to combat. A strong verb conveying active resistance against disease.", "category": "Public Health", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    ...
    {"english": "Traditional medicine", "kinyarwanda": "Ubuvuzi gakondo",
 "variants_rw": "Ubuvuzi bukoresha imiti gakondo / Imiti ikomoka ku bimera",
 "variants_en": "Herbal remedies", "example_en": "Other patients told me they now use herbal remedies.", "example_rw": "Abandi bayirwaye bakambwira bati dusigaye dukoresha imiti ikomoka ku bimera.", "etymology": "'Ubuvuzi' = treatment. 'Gakondo' = traditional, reflecting that traditional medication was based on herbal remedies. The variants are 'Ubuvuzi bukoresha imiti gakondo' = treatment using traditional medicine, and 'Imiti ikomoka ku bimera' = medicine that comes from plants.", "category": "Traditional Medicine", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    {"english": "Health behavior", "kinyarwanda": "Imyifatire",
 "variants_en": "Lifestyle conduct", "example_en": "They tell me how I should behave and how I should eat.", "example_rw": "Bambwire uko ngomba kwitwara nuko ngomba kurya.", "etymology": "From 'kwifata' = to conduct oneself. 'Imyifatire' = manner of self-conduct. In diabetes context, encompasses diet, medication adherence, exercise, and all behavioral management.", "category": "Public Health", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    {"english": "Clinical instructions", "kinyarwanda": "Amabwiriza yo kwa muganga",
 "variants_en": "Doctor's recommendations", "example_en": "Provide me with the doctor's instructions on how I should behave and the medication I should take.", "example_rw": "Bampe amabwiriza yo kwa muganga yuko ngomba kwitwara, n'imiti ngomba gufata.", "etymology": "'Amabwiriza' = instructions (from 'kubwiriza' = to instruct). 'Yo kwa muganga' = from the doctor. Specifies the clinical source of authority.", "category": "Health Systems", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    {"english": "Barriers to care", "kinyarwanda": "Imbogamizi zibuza kuvurwa",
 "variants_rw": "Imbogamizi zibangamira kwitabwaho", "example_en": "What are the challenges you face in implementing strategies prescribed by the doctor?", "example_rw": "Imbogamizi zibangamira kwitabwaho uhura nazo mu gushyira mu bikorwa ingamba wahawe na muganga nizihe?", "etymology": "'Imbogamizi' = obstacles (from 'kubogamiza' = to obstruct). 'Zibangamira kwitabwaho' = that hinder being cared for. 'Zibuza kuvurwa' = that prevent being treated.", "category": "Health Systems", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    ...
    {"english": "Health advice", "kinyarwanda": "Inama z'ubuzima",
 "variants_en": "Medical counseling", "example_en": "Especially in advice... and also about medical care.", "example_rw": "Cyane cyane ku nama... nibijyanye no kwivuza.", "etymology": "'Inama' = advice/counsel. 'Z'ubuzima' = of health. Patients overwhelmingly identify the need for health advice as their primary unmet need.", "category": "Health Systems", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    {"english": "Healthcare assistance", "kinyarwanda": "Ubwunganizi mu kuvurwa",
 "variants_rw": "Ubwunganizi bwita ku buzima",
 "variants_en": "Medical support", "example_en": "In which side do you need further assistance?", "example_rw": "Ni mu ruhe ruhande ukeneye ubwunganizi bwita ku buzima bwisumbuye ho?", "etymology": "'Ubwunganizi' = support/assistance (from 'kunganira' = to support). 'Bwita ku buzima' = that cares for health. 'Mu kuvurwa' = in being treated.", "category": "Health Systems", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    {"english": "Information dissemination", "kinyarwanda": "Gusakaza amakuru",
 "variants_en": "Health sensitization", "example_en": "Which adequate means should be used to disseminate needed information?", "example_rw": "Ni ubuhe buryo buboneye bwifashishwa mu gusakaza amakuru akenewe?", "etymology": "'Gusakaza' = to scatter/spread/disseminate. 'Amakuru' = information/news. A precise verb for health communication campaigns.", "category": "Public Health", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    ...
    {"english": "Health follow-up", "kinyarwanda": "Gukurikirana ubuzima",
 "variants_en": "Medical monitoring", "example_en": "Maybe I would have a health follow-up and then tell me where to get medications.", "example_rw": "Wenda mwajya munkurikirana mukareba ko mwandangira cyangwa mwampa imiti ngomba gukoresha.", "etymology": "'Gukurikirana' = to follow up / to track / to monitor. 'Ubuzima' = health. Describes the active, ongoing process of medical monitoring.", "category": "Clinical Practice", "contributed_by": "Christophe Mumaragishyika", "source": "Diabetes Type II IDI transcripts (2020)"},
    # =================================================================
    ...
    {"english": "Doctor", "kinyarwanda": "Umuganga",
 "variants_en": "Physician", "example_en": "The doctor examined the patient carefully.", "example_rw": "Umuganga yasuzumye umurwayi yitonze.", "etymology": "Established Kinyarwanda term used universally across all clinical contexts in Rwanda.", "category": "General Medicine", "contributed_by": "Christophe Mumaragishyika", "source": "SP/PEDS letter (Khris translation, 2025)"},
    {"english": "Headache", "kinyarwanda": "Kubabara umutwe",
 "variants_rw": "Kuribwa n'umutwe / Kuribwa umutwe", "example_en": None, "example_rw": None, "etymology": None, "category": "Neurology / Symptoms", "contributed_by": "Christophe Mumaragishyika", "source": "Search log demand (Apr 2026)"},
    ...
    {"english": "Swelling", "kinyarwanda": "Kubyimba",
 "variants_rw": "Kubyimbagatana", "example_en": None, "example_rw": None, "etymology": None, "category": "Symptoms", "contributed_by": "Christophe Mumaragishyika", "source": "Search log demand (Apr 2026)"},
    ...
    {"english": "Palliative care", "kinyarwanda": "Ubufasha nyunganiramibereho",
 "variants_rw": "Ubuvuzi mpozaburibwe", "example_en": None, "example_rw": None, "etymology": "'Mpoza' from 'guhoza/guturisha' (to comfort). 'Buribwe' from 'uburibwe' (pain). Palliative care is a medical specialty focused on comfort while treating serious illness — fixing physical discomfort, easing the mind. 'Nyunganiramibereho' = supporting quality of life.", "category": "Clinical Practice", "contributed_by": "Aimable Uwimana (Mugenzi)", "source": "Community suggestion — Mugenzi (UGHE)"},
    {"english": "Interview (research methodology)", "kinyarwanda": "Ikiganiro mbona-nkubone", "example_en": None, "example_rw": None, "etymology": "Interviewing involves asking questions face to face and exchanging speech. 'Kuganira' = holding a talk. 'Mbona-nkubone' = live, face to face.", "category": "Research Methodology", "contributed_by": "Benithe Himbazwa", "source": "Community suggestion — Benithe Himbazwa (UGHE student)"},
    {"english": "Health management", "kinyarwanda": "Igenamigambi ncungamikorere mu buvuzi", "example_en": None, "example_rw": None, "etymology": "'Igenamigambi' from 'kugena imigambi' = planning. 'Ncungamikorere' = leading operations. Health management involves leading, planning, and coordinating medical services, focusing on operational efficiency, staff management, and patient outcomes.", "category": "Health Systems", "contributed_by": "Benithe Himbazwa", "source": "Community suggestion — Benithe Himbazwa (UGHE student)"},
 ...
 "variants_en": "Department", "example_en": "I work in the Division of Clinical Medicine.", "example_rw": "Nkorera mu ishami nshingwabikorwa rishinzwe abakozi.", "etymology": "'Ishami' = branch/division. 'Nshingwabikorwa' = assigned operations/responsibilities. Established institutional term.", "category": "Institutional", "contributed_by": "Christophe Mumaragishyika", "source": "SP/PEDS letter (Khris translation, 2025)"},
    ...
    # =================================================================
    # COMMUNITY SUGGESTIONS (April 2026, Term Tracker Review 2)
    # 18 terms from Yvette Nkurunziza (native-speaker MD); 1 from Cara Nkurunziza.
    # =================================================================
    {"english": 'Constipation', "kinyarwanda": 'Impatwe', "example_en": None, "example_rw": None, "etymology": None, "category": 'Gastroenterology', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
    {"english": 'Shortness of breath', "kinyarwanda": "Guhera umwuka",
 "variants_rw": "Kubura umwuka", "example_en": None, "example_rw": None, "etymology": "'Umwuka' = air. 'Guhera umwuka' = air running out; 'kubura umwuka' = to lack air. Both render the deficiency descriptively, paralleling 'kubura amaraso' (anemia, 'to lack blood').", "category": 'Symptoms', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
    {
        "english": "Abortion",
        "kinyarwanda": "Gukuramo inda",
        "example_en": None,
        "example_rw": None,
        "etymology": "'Gukuramo' = to remove; 'kuvamo' = to exit or leave. Both describe a pregnancy that has ended, but 'gukuramo inda' names one deliberately ended, while 'inda yavuyemo' names one that ended of itself.",
        "category": "Reproductive Health",
        "contributed_by": "Yvette Nkurunziza",
 ...
 "variants_rw": "Ubugumba", "example_en": None, "example_rw": None, "etymology": None, "category": 'Reproductive Health', "contributed_by": 'Yvette Nkurunziza', "source": "Community suggestion — Yvette Nkurunziza (April 2026); variant 'Ubugumba' from Virginie Mpuhwezimana, August 2026 collection"},
    ...
    {"english": 'Tumor', "kinyarwanda": 'Ikibyimba', "example_en": None, "example_rw": None, "etymology": None, "category": 'Oncology', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
 ...
 "variants_rw": "Indwara y'igicuri", "example_en": None, "example_rw": None, "etymology": None, "category": 'Neurology', "contributed_by": 'Yvette Nkurunziza', "source": "Community suggestion — Yvette Nkurunziza (April 2026); variant 'Indwara y'igicuri' from Sarah Izabayo, August 2026 collection"},
    ...
    {"english": 'Vaccine', "kinyarwanda": 'Urukingo', "example_en": None, "example_rw": None, "etymology": "'Urukingo' from the verb 'gukingira' (to protect/prevent), the vaccine being the means of protection. 'Vaccin' is the French form still used by some speakers.", "category": 'Public Health', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
    {"english": 'AIDS', "kinyarwanda": 'SIDA', "example_en": None, "example_rw": None, "etymology": "'SIDA' is the borrowed French acronym, now naturalized in Kinyarwanda. Colloquial forms include igiswaku, agaswaku, agasimba, umugera, and ikimungu.", "category": 'Infectious Disease', "contributed_by": 'Yvette Nkurunziza', "source": 'Community suggestion — Yvette Nkurunziza (April 2026)'},
